      ...
      <div className="max-w-md w-full space-y-8">
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-none relative block w-full px-4 py-3 border rounded-t-md focus:outline-none focus:z-10 sm:text-sm"
                style={{
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-none relative block w-full px-4 py-3 border rounded-b-md focus:outline-none focus:z-10 sm:text-sm"
                style={{
                  backgroundColor: 'var(--bg-tertiary)',
                  borderColor: 'var(--border-primary)',
                  color: 'var(--text-primary)'
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <button
              ...
              disabled={isLoading}
              className="w-full inline-flex justify-center py-2 px-3 border rounded-md shadow-sm text-sm font-medium disabled:opacity-50"
              style={{
        ...
        <div className="text-center mt-8">
          <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
            Protected by world-class security:<br />
            JWT Authentication • OAuth2 • Rate Limiting • Encryption • GDPR Compliant
          </p>
          <p className="text-xs mt-4" style={{ color: 'var(--text-muted)' }}>
            Demo users: <strong style={{ color: 'var(--accent-blue)' }}>admin@cqox.local / admin123</strong><br />
            analyst@cqox.local / analyst123 | viewer@cqox.local / viewer123
          </p>
        </div>
      </div>
    </div>
