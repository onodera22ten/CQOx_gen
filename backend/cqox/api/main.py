...
from cqox.api.routes import datasets_v2
...
# Include new SQLAlchemy-based datasets router (v2)
...
# app.include_router(datasets.router, prefix=f"{settings.api_prefix}/datasets", tags=["datasets"])  # Replaced by datasets_v2
